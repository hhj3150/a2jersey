...
const FAQS: FAQItem[] = [
  {
    q: '국내산 A2 저지 우유를 어디서 살 수 있나요?',
    a: '송영신목장은 경기도 안성에서 A2 Jersey Hay Milk를 생산하며, 6월 1일부터 정기구독 서비스를 준비하고 있습니다.',
  },
  {
    q: '송영신목장 우유는 어떤 우유인가요?',
    a: '송영신목장 A2 Jersey Hay Milk는 A2 단백질, 저지 원유, 건초 중심 사양, 목장형 유가공공장을 기반으로 한 프리미엄 우유입니다.',
  },
  {
    q: 'A2 Jersey Hay Milk란 무엇인가요?',
    a: 'A2 단백질을 가진 저지소의 우유를 기반으로, 건초 중심 사양 철학을 반영한 송영신목장의 프리미엄 우유입니다.',
  },
  {
    q: '정기구독은 언제 시작되나요?',
